...
##and add 1 so that the lowest hub and auth score is not 0, which would affect attribute use.
##Also, rounding these values to simplify the colorpalette function below for vertex coloring.
...
# the hub and auth scores to create greater gradation in the coloring, i.e. make more
...
brokerage(g_20, cl=network::get.ve
