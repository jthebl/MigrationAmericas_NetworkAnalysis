...
```{r Load Data, include=FALSE}
  ...
  # Load the graphs
  g_1990 <- readRDS("Constructing_Networks/igraph Objects/g_1990.rds")
  g_2000 <- readRDS("Constructing_Networks/igraph Objects/g_2000.rds")
  g_2010 <- readRDS("Constructing_Networks/igraph Objects/g_2010.rds")
  g_2020 <- readRDS("Constructing_Networks/igraph Objects/g_2020.rds")
...
```{r Plotting - Edge Thickness based on Migrant Flow, include=TRUE}
...
```{r Plot - Edge Thickness All Networks, include=TRUE}
